 ...
 *//**
	 ...
	 *//*
		 ...
		 * String body){ try { MimeMessage msg = new MimeMessage(session); //set message
		 * headers msg.addHeader("Content-type", "text/HTML; charset=UTF-8");
		 ...
		 * false)); System.out.println("Message is ready"); Transport.send(msg);
		 * 
